...
import com.ur.apps.walk.step.db.WalkAppDatabase;
...
public class DbUtils {
    private static WalkAppDatabase database;
    private static final ExecutorService databaseExecutor = Executors.newSingleThreadExecutor();

    public static void createDb(Context context) {
        if (database == null) {
            database = WalkAppDatabase.getInstance(context);
        }
    }

    public static WalkAppDatabase getDatabase() {
