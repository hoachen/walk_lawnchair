        ...
        RewardedAd.load(
            ...
            object : RewardedAdLoadCallback() {
                    ...
                    rewardedAd?.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            ...
                            override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                                ...
                                rewardedAd = null
                                internalRewardAdListeners.forEach {
                                    it.onRewardedVideoAdPlayFailed(this@LauncherAdmobAdLoader, adError.message)
                                }
                            }
                            ...
                            override fun onAdShowedFullScreenContent() {
                                ...
                                internalRewardAdListeners.forEach {
                                    it.onRewardedAdPlayStart(this@LauncherAdmobAdLoader)
                                }
                            }
                            ...
                            override fun onAdClicked() {
                                ...
                                internalRewardAdListeners.forEach {
                                    it.onRewardedAdPlayClicked(this@LauncherAdmobAdLoader)
                                }
                            }
                        }

                    internalRewardAdListeners.forEach {
                        it.onRewardedAdLoaded(this@LauncherAdmobAdLoader)
                    }
                }
                ...
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ...
                    rewardedAd = null
                    internalRewardAdListeners.forEach {
                        it.onRewardedAdFailed(this@LauncherAdmobAdLoader, adError.message)
                    }
                }
            },
        )
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                    ...
                    interstitialAd?.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            ...
                            override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                                ...
                                interstitialAd = null
                                internalInterstitialAdListeners.forEach {
                                    it.onInterstitialAdVideoError(this@LauncherAdmobAdLoader, adError.message)
                                }
                            }
                            ...
                            override fun onAdShowedFullScreenContent() {
                                ...
                                internalInterstitialAdListeners.forEach {
                                    it.onInterstitialAdVideoStart(this@LauncherAdmobAdLoader)
                                }
                            }
                            ...
                            override fun onAdImpression() {
                                ...
                                internalInterstitialAdListeners.forEach {
                                    it.onInterstitialAdShow(this@LauncherAdmobAdLoader)
                                }
                            }
                            ...
                            override fun onAdClicked() {
                                ...
                                internalInterstitialAdListeners.forEach {
                                    it.onInterstitialAdClicked(this@LauncherAdmobAdLoader)
                                }
                            }
                        }
                    internalInterstitialAdListeners.forEach {
                        it.onInterstitialAdLoaded(this@LauncherAdmobAdLoader)
                    }
                }
                ...
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ...
                    interstitialAd = null
                    internalInterstitialAdListeners.forEach {
                        it.onInterstitialAdLoadFail(this@LauncherAdmobAdLoader, adError.message)
                    }
                }
            },
        )
        ...
        bannerAd?.adListener = object : AdListener() {
                override fun onAdClicked() {
                    ...
                    internalBannerAdListeners.forEach {
                        it.onBannerAdClicked(this@LauncherAdmobAdLoader)
                    }
                ...
                override fun onAdClosed() {
                    ...
                    internalBannerAdListeners.forEach {
                        it.onBannerAdOpened(this@LauncherAdmobAdLoader)
                    }
                }
                ...
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ...
                    internalBannerAdListeners.forEach {
                        it.onBannerAdLoadFail(this@LauncherAdmobAdLoader, adError.message)
                    }
                    bannerAd = null
                }
                ...
                override fun onAdImpression() {
                    ...
                    internalBannerAdListeners.forEach {
                        it.onBannerAdShow(this@LauncherAdmobAdLoader)
                    }
                ...
                override fun onAdLoaded() {
                    ...
                    internalBannerAdListeners.forEach {
                        it.onBannerAdLoaded(this@LauncherAdmobAdLoader)
                    }
                }
                        ...
                        object : AdListener() {
                            override fun onAdFailedToLoad(adError: LoadAdError) {
                                ...
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdLoadFail(this@LauncherAdmobAdLoader, adError.message)
                                }
                            }
                            ...
                            override fun onAdClicked() {
                                ...
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdClicked(this@LauncherAdmobAdLoader)
                                }
                            ...
                            override fun onAdImpression() {
                                ...
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdShow(this@LauncherAdmobAdLoader)
                                }
                            ...
                            override fun onAdClosed() {
                                ...
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdClose(this@LauncherAdmobAdLoader)
                                }
                            }
                            ...
                            override fun onAdLoaded() {
                                ...
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdLoaded(this@LauncherAdmobAdLoader)
                                }
                            }
                            ...
                            override fun onAdOpened() {
                                super.onAdOpened()
                                internalNativeAdListeners.forEach {
                                    it.onNativeAdOpened(this@LauncherAdmobAdLoader)
                                }
                            }
                        }
                    )
