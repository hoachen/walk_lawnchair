...
object LogUtils {
    ...
    private fun shareFile(
        ...
        try {
            ...
            URLog.e(TAG, context.getString(com.ur.apps.walk.R.string.log_share_failed_toast), e)
            Toast.makeText(context, context.getString(com.ur.apps.walk.R.string.log_share_failed_toast), Toast.LENGTH_SHORT).show()
        }
    }
